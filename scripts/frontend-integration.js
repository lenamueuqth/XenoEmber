 ...
 * This file demonstrates how to integrate Xenoember with a web frontend
 */

// For React/Vue/Angular applications
export class XenoemberClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new XenoemberClient(provider, contractAddress);
